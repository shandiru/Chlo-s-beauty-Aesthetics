...
const treatments = [
 
  {
    ...
    title: "HydraFacial",
    description:
      "Reveal radiant, glowing skin with our deep-cleansing HydraFacial treatment. This multi-step facial exfoliates, extracts, and hydrates to leave your skin refreshed, smooth, and visibly rejuvenated.",
    badges: [
    ...
    list: [
      ...
      "Hydration boost",
      "Minimised pores and fine lines",
  ...
  },
  {
    ...
    description:
      "Pamper your hands with our expert nail care service. From precise shaping to flawless polish, enjoy perfectly groomed nails that complement your style and confidence.",
    badges: [
      { icon: <Clock className="h-3 w-3 mr-1" />, text: "45–60 mins" },
      { icon: <Sparkles className="h-3 w-3 mr-1" />, text: "Results: Instant" },
    ],
